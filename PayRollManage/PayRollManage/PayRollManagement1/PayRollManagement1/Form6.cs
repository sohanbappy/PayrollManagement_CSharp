...
namespace PayRollManagement1
{
    public partial class infoForm : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            f6tb8.Text = dataGridView1.CurrentRow.Cells[12].Value.ToString();
        ...
        {
            string insertQry = "INSERT INTO `employee_info`(`em_id`, `name`, `phone`, `designation`, `dept`, `gender`, `date_of_birth`, `date_of_join`, `bl_group`, `basic`, `address`,`password`,`mail`) VALUES ('" + f6tb1.Text+ "','" + f6tb2.Text + "','" + f6tb3.Text + "','" + f6tb4.Text + "','" + comboBox1.Text + "','" + comboBox2.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "','" + comboBox3.Text + "','" + f6tb5.Text + "','" + f6tb6.Text + "','" + f6tb7.Text + "','" + f6tb8.Text + "')";
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            string delQry1 = "DELETE FROM employee_info WHERE em_id = '" + f6tb1.Text + "' ";
            DbConnection.Delete(delQry1);
            string delQry2 = "DELETE FROM attendance WHERE em_id = '" + f6tb1.Text + "' ";
            DbConnection.Delete(delQry2);
            string delQry3 = "DELETE FROM salary WHERE em_id = '" + f6tb1.Text + "' ";
            DbConnection.Delete(delQry3);
