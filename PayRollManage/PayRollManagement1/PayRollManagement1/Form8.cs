...
namespace PayRollManagement1
{
    public partial class leaveForm : Form
    {
        ...
        public void Insert()
        {
            ...
            con.Open();
            string sql = "INSERT INTO `leave_info` (`em_id`, `leave_type`, `from_date`,`to_date`,`days`,`status`) VALUES('" + f8tb1.Text + "','" + comboBox1.Text + "','" + dateTimePicker1.Text + "','" + dateTimePicker2.Text + "','"+diff+ "','" + f8tb3.Text + "')";
